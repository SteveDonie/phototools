@echo off
echo Making just Handyman album and then syncing to S3
...
echo %TIME% - Starting syncHandyman.bat >> timing.txt
call syncHandyman.bat
echo %TIME% - Finished syncHandyman.bat >> timing.txt
