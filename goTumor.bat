@echo off
echo Making brain tumor album and then syncing to S3
...
echo. >> timing.txt
echo Time to make Brain Tumor >> timing.txt
...
echo %TIME% - Starting syncTumor.bat >> timing.txt
call syncTumor.bat
echo %TIME% - Finished syncTumor.bat >> timing.txt
